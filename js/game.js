...
function create() {
	...
	logo_button = game.add.button(0, 0, '', function() { window.open('https://www.wishes.inc/', '_blank');});
...
function update() {
	...
	if(score >= SCORE_NEEDED && gameOver == false){
...
function make_win_screen() {
	...
	sign_up_button = game.add.button(0, 0, '', restart_game);
